    ...
    <div>
      <div className="mb-16">
        ...
        <img
          ...
          src="/images/Portfolio Details/Noble/NoblePharmaLogo.png"
          alt=""
        />
        </div>
...
/>
      ...
      <div className="mb-16">
        ...
        <div>
          ...
          src="/images/Portfolio Details/Noble/splashscreen.png"
          alt=""
        />
        </div>
          ...
          <img
          className="w-full h-full object-contain"
          src="/images/Portfolio Details/Noble/welcome.jpeg"
          alt=""
        />
          </div>
          <div>
          <img
          className="w-full h-full object-contain"
          src="/images/Portfolio Details/Noble/step_1_a.jpeg"
          alt=""
        />
          </div>
          ...
          <img
          className="w-full h-full object-contain"
          src="/images/Portfolio Details/Noble/step_2_a.jpeg"
          alt=""
        />
          </div>
          </div>
      ...
      <div className="mb-16">
        ...
        <div  className="flex flex-row space-x-2.5">
          ...
          <img
          className="w-full h-full object-contain"
          src="/images/Portfolio Details/Noble/step_3_a.jpeg"
          alt=""
        />
          </div>
          ...
          <img
          className="w-full h-full object-contain"
          src="/images/Portfolio Details/Noble/step_4_a.jpeg"
          alt=""
        />
          </div>
          <div>
          <img
          className="w-full h-full object-contain"
          src="/images/Portfolio Details/Noble/step_5_a.jpeg"
          alt=""
        />
          </div>
      ...
      <div className="mb-16">
        ...
        />
          ...
          <img
          className="w-full h-full object-contain"
          src="/images/Portfolio Details/Noble/step1.jpeg"
          alt=""
        />
          </div>
          <div>
          <img
          className="w-full h-full object-contain"
          src="/images/Portfolio Details/Noble/step2.jpeg"
          alt=""
        />
          </div>
          <div>
          <img
          className="w-full h-full object-contain"
          src="/images/Portfolio Details/Noble/step3.jpeg"
          alt=""
        />
          </div>
          </div>
