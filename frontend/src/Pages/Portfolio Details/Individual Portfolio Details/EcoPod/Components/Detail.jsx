        ...
        <div  className="flex flex-col gap-5">
          ...
          <>
            <div className="flex sm:flex-row flex-col items-center gap-5 w-full h-full">
              <video controls className="cursor-pointer sm:w-1/2 w-9/12 h-full object-contain">
                <source src="https://toggletechlab.s3.us-east-2.amazonaws.com/EcoPod/ecopodvd2.mp4" type="video/mp4" />
              </video>
              <video controls className="cursor-pointer sm:w-1/2 w-9/12 h-full object-contain">
                <source src="https://toggletechlab.s3.us-east-2.amazonaws.com/EcoPod/ecopodvd4.mp4" type="video/mp4" />
              </video>
            </div>
            <div className="flex sm:flex-row flex-col items-center w-full h-full">
              <video controls className="cursor-pointer sm:w-1/2 w-9/12 h-1/2 object-contain">
                <source src="https://toggletechlab.s3.us-east-2.amazonaws.com/EcoPod/ecopodvd3.mp4" type="video/mp4" />
              </video>
            </div>
          </>

          
            <div className="xxl:w-6/12 xl:w-7/12 sm:w-8/12 w-full 
          lg:h-72 h-68">
          <img
