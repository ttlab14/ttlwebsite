    ...
    <div>
      ...
      <div 
        ...
        >
          <img
            ...
            src="/images/Portfolio Details/ArtStudio/ukraine_ar.jpeg"
            alt=""
            style={{width:"30%"}}
          ...
          <img
            className="lg:w-7/12 sm:w-6/12 xs:w-9/12 h-full object-contain"
            src="/images/Portfolio Details/ArtStudio/QRCode.jpeg"
            alt=""
            style={{width:"23%"}}
          />
        </div>
      ...
      <div className="mb-16">
        ...
        <img
            ...
            src="/images/Portfolio Details/ArtStudio/art1.png"
            alt=""
          />
        </div>
        <div className="flex sm:flex-row flex-col gap-5 items-center my-5">
        <img
            className="w-full h-full object-fill"
            src="/images/Portfolio Details/ArtStudio/art2.png"
            alt=""
          />
        </div>
...
<div className="flex sm:flex-row flex-col gap-5 items-center my-5">
        <img
            className="w-full h-full object-fill"
            src="/images/Portfolio Details/ArtStudio/art3.png"
            alt=""
          />
        </div>
