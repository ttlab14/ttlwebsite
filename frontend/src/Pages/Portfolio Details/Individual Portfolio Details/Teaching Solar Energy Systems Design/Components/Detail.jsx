    ...
    <div>
      <div className="mb-16">
        ...
        <img
          ...
          src="/images/Portfolio Details/Solar/glasgowuni-removebg-preview.png"
          alt=""
        />
        </div>
      ...
      <div  className="flex flex-row space-x-2.5">
        <div>
          <img
          className="w-full h-full object-contain"
          src="/images/Portfolio Details/Solar/solar0.png"
          alt=""
        />
        </div> 
        ...
        <div>
          ...
          src="/images/Portfolio Details/Solar/solar2.png"
          alt=""
        />
        </div> 
          </div>
        ...
        <div>
          <img
          className="w-full h-full object-contain"
          src="/images/Portfolio Details/Solar/solar7.png"
          alt=""
        />
        </div> 
        ...
        <div>
          <img
          className="w-full h-full object-contain"
          src="/images/Portfolio Details/Solar/solar8.png"
          alt=""
        />
        </div> 
          </div>
        ...
        <div>
          <img
          className="w-full h-full object-contain"
          src="/images/Portfolio Details/Solar/solar3.png"
          alt=""
        />
        </div> 
        ...
        <div>
          <img
          className="w-full h-full object-contain"
          src="/images/Portfolio Details/Solar/solar4.png"
          alt=""
        />
        </div> 
          </div>
        ...
        <div>
          <img
          className="w-full h-full object-contain"
          src="/images/Portfolio Details/Solar/solar5.png"
          alt=""
        />
        </div> 
        ...
        <div>
          <img
          className="w-full h-full object-contain"
          src="/images/Portfolio Details/Solar/solar6.png"
          alt=""
        />
        </div> 
          </div>
