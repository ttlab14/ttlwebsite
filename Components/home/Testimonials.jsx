        ...
        <div className="md:flex justify-between items-center  mb-8">
          ...
          <div className="flex mt-4 md:mt-0">
            <div
              ...
              className="cursor-pointer rounded-full border border-dark-grey w-14 h-14 flex justify-center items-center mr-4"
            >
              <img
                src="https://toggletechlab.s3.us-east-2.amazonaws.com/Icons/Chevron+Left.svg"
                alt=""
              />
            </div>
            <div
              onClick={() => swiperRef.current.swiper.slideNext()}
              className="cursor-pointer rounded-full border border-dark-grey w-14 h-14 flex justify-center items-center"
            >
              <img
                src="https://toggletechlab.s3.us-east-2.amazonaws.com/Icons/Chevron+Right.svg"
                alt=""
              />
            </div>
          </div>
          ...
          <SwiperSlide>
            ...
            <div className="">
              <div className="mr-1 md:mr-4 border border-dark-grey rounded-xl py-6 px-8  mb-3">
                <img
                  className="w-12 h-10"
                  src="https://toggletechlab.s3.us-east-2.amazonaws.com/Icons/quote.svg"
                  alt=""
                />
                <p className="text-grey text-base md:text-lg mt-8">
