...
Director          </p>
        ...
        <div className="flex flex-col items-center md:justify-center mb-12">
          <div className="w-32 h-32  md:w-52 md:h-52 rounded-full overflow-hidden">
            <img
              src="https://toggletechlab.s3.us-east-2.amazonaws.com/Team/Team-2.png"
              alt="Toggle Tech Lab Team"
            />
          </div>
          <h1 className="text-white text-xl mt-4 mb-1 text-center">
        ...
        <div className="flex flex-col items-center md:justify-center mb-12">
          <div className="w-32 h-32  md:w-52 md:h-52 rounded-full overflow-hidden">
            <img
              src="https://toggletechlab.s3.us-east-2.amazonaws.com/Team/bikram.jpg"
              alt="Toggle Tech Lab Team"
            />
          </div>
        ...
        <div className="flex flex-col items-center md:justify-center mb-12">
          <div className="w-32 h-32  md:w-52 md:h-52 rounded-full overflow-hidden">
            <img
              src="https://toggletechlab.s3.us-east-2.amazonaws.com/Team/venky.jpg"
              alt="Toggle Tech Lab Team"
            />
          </div>
          <h1 className="text-white text-xl mt-4 mb-1 text-center">
        ...
        <div className="flex flex-col items-center md:justify-center mb-12">
          <div className="w-32 h-32  md:w-52 md:h-52 rounded-full overflow-hidden">
            <img
              src="https://toggletechlab.s3.us-east-2.amazonaws.com/Team/brian.jpg"
              alt="Toggle Tech Lab Team"
            />
          </div>
        ...
        <div className="flex flex-col items-center md:justify-center mb-12">
          <div className="w-32 h-32  md:w-52 md:h-52 rounded-full overflow-hidden">
            <img
              src="https://toggletechlab.s3.us-east-2.amazonaws.com/Team/sonya.jpg"
              alt="Toggle Tech Lab Team"
            />
          </div>
          <h1 className="text-white text-xl mt-4 mb-1 text-center">Sonya</h1>
          <p className="text-gold text-base md:text-lg text-center">
            XR User Experience Designer
          </p>
        </div>
        <div className="flex flex-col items-center md:justify-center mb-12">
          <div className="w-32 h-32  md:w-52 md:h-52 rounded-full overflow-hidden">
            <img
              src="https://toggletechlab.s3.us-east-2.amazonaws.com/Team/rohit.PNG"
              alt="Toggle Tech Lab Team"
            />
          </div>
